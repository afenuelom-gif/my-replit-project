...
import { Mic, Video, VideoOff, SquareSquare, Activity, Loader2, MessagesSquare, XCircle, LogIn, UserPlus } from "lucide-react";
import InterviewerCard, { type InterviewerCardHandle } from "@/components/InterviewerCard";
import { useClerk } from "@clerk/react";

function InterviewAuthPrompt() {
          ...
          <CardContent className="py-10 text-center space-y-5">
            <div className="space-y-2">
              ...
              <p className="text-zinc-400 text-sm max-w-sm mx-auto">
                Please sign back in to continue your interview. You'll be returned here automatically after signing in.
              </p>
            </div>
